//
//  KSPMirroredSectionedFetchedResultsControllerExteriorMovesTest.m
...
@interface KSPMirroredSectionedFetchedResultsControllerExteriorMovesTest : XCTestCase

@end

@implementation KSPMirroredSectionedFetchedResultsControllerExteriorMovesTest
{
...
- (void) setUp
{
  ...
  XCTAssert(_MSFRC.fetchedObjects.count == 8, @"fetchedObjects count should be 8.");
}
...
- (void) testSequentialMessageMoves
{
  {{
    ...
    [verify(_delegate) controller: _MSFRC willChangeObject: _msg0 atIndex: 3 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 4 inSection: instanceOf([KSPTableSection class])];

    [verify(_delegate) controller: _MSFRC didChangeObject: _msg0 atIndex: 3 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 4 inSection: instanceOf([KSPTableSection class])];
  }}
  ...
  {{
    ...
    [verify(_delegate) controller: _MSFRC willChangeObject: _msg3 atIndex: 0 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 4 inSection: instanceOf([KSPTableSection class])];

    [verify(_delegate) controller: _MSFRC didChangeObject: _msg3 atIndex: 0 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 4 inSection: instanceOf([KSPTableSection class])];
  }}
  ...
  {{
    ...
    [verify(_delegate) controller: _MSFRC willChangeObject: _msg1 atIndex: 1 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 5 inSection: instanceOf([KSPTableSection class])];

    [verify(_delegate) controller: _MSFRC didChangeObject: _msg1 atIndex: 1 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 5 inSection: instanceOf([KSPTableSection class])];
  }}
  ...
  {{
    ...
    [verify(_delegate) controller: _MSFRC willChangeObject: _msg2 atIndex: 0 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 5 inSection: instanceOf([KSPTableSection class])];

    [verify(_delegate) controller: _MSFRC didChangeObject: _msg2 atIndex: 0 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 5 inSection: instanceOf([KSPTableSection class])];

    [verify(_delegate) controller: _MSFRC didChangeSection: instanceOf([KSPTableSection class]) atIndex: 1 forChangeType: KSPSectionedFetchedResultsChangeDelete newIndex: NSNotFound];
  }}
  ...
  {{
    ...
    [verify(_delegate) controller: _MSFRC didChangeSection: instanceOf([KSPTableSection class]) atIndex: NSNotFound forChangeType: KSPSectionedFetchedResultsChangeInsert newIndex: 1];

    [verify(_delegate) controller: _MSFRC willChangeObject: _msg7 atIndex: 0 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 0 inSection: instanceOf([KSPTableSection class])];
    
    [verify(_delegate) controller: _MSFRC didChangeObject: _msg7 atIndex: 0 inSection: instanceOf([KSPTableSection class]) forChangeType: KSPFetchedResultsChangeMove newIndex: 0 inSection: instanceOf([KSPTableSection class])];
  }}
}
